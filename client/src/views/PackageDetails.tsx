      ...
      <Row className="g-5">
        <Col lg={7}>
          {pkg.image_url ? (
            ...
            <div className="bg-light rounded-4 shadow mb-4 w-100 d-flex align-items-center justify-content-center text-muted" style={{ height: '300px' }}>
              <span className="fs-1">🖼️ No Image Provided</span>
            </div>
          )}
          <h1 className="fw-bolder mb-3 text-dark">{pkg.title}</h1>
          <div className="d-flex flex-wrap gap-4 mb-4 text-muted border-bottom pb-4">
        ...
        <Col lg={5}>
          <Card className="shadow-lg border-0 rounded-4 sticky-top" style={{ top: '100px' }}>
            <Card.Body className="p-4 p-md-5">
              ...
              <Form onSubmit={handleBook}>
                ...
                <div className="bg-light p-4 rounded-4 mb-4 mt-2">
